...
const questions = [
    {
      ...
      options: ["1. Strings of characters", "2. Booleans", "3. Alerts", "4. Numbers"],
      answer: "3. Alerts",
    },
    {
      questionText: "JavaScript arrays can be used to store ______.",
      options: [
    ...
    {
      questionText:
        "Strings must be included in _____ when assigned to variables.",
      options: ["1. Commas", "2. Braces", "3. Quotes", "4. Brackets"],
      answer: "3. Quotes",
    },
    {
      questionText:
        "A very useful tool used during development and debugging to print content to the debugger is:",
      options: [
        "1. JavaScript",
        "2. Terminal",
        "3. The << for >> loops",
    ...
    {
      questionText:
        "Which of the following statements can be used to end a loop, switch or label?",
      options: ["1. Break", "2. Stop", "3. Halt", "4. Exit"],
      answer: "1. Break",
    },
    {
      questionText:
        "What is the most appropriate programming language for video games?",
        options: ["1. Python", "2. Java", "3. HTML/CSS/PHP/JS", "4. C/C++/C#"],
        answer: "4. C/C++/C#"
    }
  ];
